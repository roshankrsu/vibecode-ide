    ...
    >
      <DialogContent className="sm:max-w-225 max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#7C3AED] flex items-center gap-2">
                <Plus size={24} className="text-[#7C3AED]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-10 focus-visible:ring-[#7C3AED]"
                  />
                </div>
                ...
                >
                  <TabsList className="grid grid-cols-4 w-full sm:w-100px">
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                            ${
                              selectedTemplate === template.id
                                ...
                                : "hover:border-[#7C3AED]/50 shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(124,58,237,0.1)]"
                            }
                            `}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#7C3AED] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}

                        <div className="flex gap-4">
                          <div className="relative w-16 h-16 shrink-0 flex items-center justify-center rounded-full bg-[#7C3AED]/10">
                            <Image
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex flex-wrap gap-2 mt-auto">
                              {template.tags.map((tag) => (
                                <span
                                  key={tag}
                                  className="text-xs px-2 py-1 border border-zinc-700 text-white bg-zinc-800 rounded-2xl"
                                >
                                  {tag}
                                </span>
                              ))}
            ...
            <div className="flex flex-col gap-6 py-4">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  className="focus-visible:ring-[#7C3AED]"
                />
              </div>

              <div className="p-4 rounded-lg border border-[#7C3AED]/30 bg-[#7C3AED]/5">
                <h3 className="font-medium mb-2 text-[#7C3AED]">
