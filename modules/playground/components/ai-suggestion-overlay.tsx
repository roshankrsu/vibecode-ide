...
export const AISuggestionOverlay: React.FC<AISuggestionOverlayProps> = ({
  ...
  return (
    <div
      className={cn(
        "absolute top-4 right-4 z-50 animate-in slide-in-from-top-2 fade-in-0 duration-300",
        className,
      )}
    >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    Generating intelligent code suggestion...
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4">
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-sm font-semibold bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent dark:from-blue-400 dark:to-purple-400">
                        AI Suggestion
                      </span>
                      <Badge
                        variant="secondary"
                    ...
                    {suggestionPosition && (
                      <div className="flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        Line {suggestionPosition.line}, Col{" "}
              ...
              <div className="mb-4">
                <div className="relative group">
                  ...
                  {!isExpanded && suggestion && suggestion.length > 100 && (
                    <div className="absolute bottom-0 left-0 right-0 h-8 bg-linear-to-t from-gray-50 dark:from-gray-800/50 to-transparent rounded-b-lg" />
                  )}
                </div>
              </div>
              ...
              <div className="flex gap-2">
                <Button
                  size="sm"
                  onClick={onAccept}
                  className="flex-1 bg-linar-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white border-0 shadow-md hover:shadow-lg transition-all duration-200"
                >
              ...
              <div className="mt-3 pt-3 border-t border-gray-100 dark:border-gray-800">
                <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                  ...
                  {copied && (
                    <span className="text-green-500 animate-in fade-in-0 duration-200">
                      Copied!
                    </span>
                  )}
                </div>
