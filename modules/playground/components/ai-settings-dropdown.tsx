    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="icon">
          <Sparkles
            className={
              isAISuggestionsEnabled ? "text-primary" : "text-muted-foreground"
            }
          />
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem
          onClick={() =>
            onToggleCodeCompletionAllFiles(!isCodeCompletionAllFilesEnabled)
          }
        >
          <div className="flex items-center gap-2">
            <input
        ...
        <DropdownMenuItem
          onClick={() => onToggleCodeCompletionTSX(!isCodeCompletionTSXEnabled)}
        >
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
              ...
              onChange={() =>
                onToggleCodeCompletionTSX(!isCodeCompletionTSXEnabled)
              }
              className="form-checkbox h-4 w-4"
            />
        ...
        <DropdownMenuItem
          onClick={() =>
            onToggleNextEditSuggestions(!isNextEditSuggestionsEnabled)
          }
        >
          <div className="flex items-center gap-2">
            <input
