...
export const PlaygroundEditor = ({
  ...
  return (
    <div className="h-full relative">
      {/* Loading indicator */}
      {suggestionLoading && (
        <div className="absolute top-2 right-2 z-10 bg-[#7C3AED]/10 dark:bg-[#7C3AED]/20 px-2 py-1 rounded text-xs text-[#7C3AED] dark:text-[#a78bfa] flex items-center gap-1">
